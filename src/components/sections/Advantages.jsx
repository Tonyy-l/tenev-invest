function Advantages({ data, items }) {
  return (
    <section id="advantages" className="relative scroll-mt-32 py-16 sm:py-20">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-sm leading-7 text-[#4f4336] sm:text-base">{data.description}</p>
        </div>
        ...
        <div className="mt-8 grid gap-4 sm:mt-10 sm:gap-6 lg:grid-cols-3">
          {items.map((item) => (
            <article
              key={item.title}
              className="rounded-[28px] border border-white/55 bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(255,255,255,0.68))] p-5 shadow-[0_12px_30px_rgba(34,28,22,0.06)] backdrop-blur-sm transition hover:-translate-y-1 hover:border-[#c4975b]/30 hover:shadow-[0_18px_40px_rgba(34,28,22,0.10)] sm:p-6"
            >
